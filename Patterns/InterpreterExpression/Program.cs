...
using InterpreterExpression.Core;

namespace InterpreterExpression
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            details.Add(new Detail() { Name = "Nut", Color = InterpreterExpression.Color.Red, City = "London", Weight = 12 });
            details.Add(new Detail() { Name = "Bolt", Color = InterpreterExpression.Color.Green, City = "Paris", Weight = 17 });
            details.Add(new Detail() { Name = "Screw", Color = InterpreterExpression.Color.Blue, City = "Rome", Weight = 17 });
            details.Add(new Detail() { Name = "Screw", Color = InterpreterExpression.Color.Red, City = "London", Weight = 14 });
            details.Add(new Detail() { Name = "Cam", Color = InterpreterExpression.Color.Blue, City = "Paris", Weight = 12 });
            details.Add(new Detail() { Name = "Cog", Color = InterpreterExpression.Color.Red, City = "London", Weight = 19 });
